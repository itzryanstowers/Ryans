...
My streamlit application comes with a peripheral amount of interactions that you can do.
1. A blcok difficulty slider that allows you to set the difficulty level of the block

2. a block inspector that allows the user to inspect a closer look at each transaction in more detail such as the prev hash, the sender and receiver id, as well as the timestamp.

3. in the main page, you are able to fill in 4 text inputs:
    - Block Data: allows you to send any message of the transaction
    - Sender: the sender of who sent the transaction
    - Receiver: the receiver of who is receiving the transaction
    - Amount: The amount of the transaction
 4. two buttons one to add the block to the chain and the other to verify the chain.
 ...
 ![Alt Text](Screenshots\Blockchain.png)
 

 ![Alt Text]("Screenshots\Blaockchain2.png")
